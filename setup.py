...
# update this!
URL = "https://github.com/OpenVoiceOS/ovos-skill-spotify"
SKILL_CLAZZ = "SpotifySkill"  # needs to match __init__.py class name
PYPI_NAME = "ovos-skill-spotify"  # pip install PYPI_NAME
...
def find_resource_files():
    ...
    resource_base_dirs = ("locale", "res", "vocab", "dialog", "regex")
